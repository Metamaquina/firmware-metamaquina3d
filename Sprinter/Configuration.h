...
// Number of motor steps per one revolution (200 for 1.8 degree, 400 for 0.9 degree motor, etc.) 
#define steps 200

// Microstepping ratio of controller (1/8 for Gen6, 1/16 for Pololu, etc.) 
#define microstepping (1/16.0)

//Distance in millimeters between teeth of belt (5.00mm for T5, 5.08mm for XL, etc.)
#define belt_pitch 5

// Number of teeth on the motor pulley gear (default is 8 teeth for T5 gears; XL gears may use 10)
#define pulley_teeth 8

// Gear ratio for extruder gears (Wade's Extruder: 39/11, Accessible Wade's by Greg Frost: 43/10, Adrian's Extruder: 59/11, etc.) 
#define ERatio (43/10)

// Diameter of hobbed bolt in millimeters, measured at hobbed section
#define bolt_diameter 7

// Distance in millimeters between threads of Z rods (1.25mm for M8)
#define Z_d 1.25

#define x_steps_per_mm (steps * (1/microstepping) / ( belt_pitch * pulley_teeth ))
#define y_steps_per_mm x_steps_per_mm
#define z_steps_per_mm (steps * (1/microstepping) / Z_d)
#define e_steps_per_mm ((steps * (1/microstepping) * ERatio) / (3.1415 * bolt_diameter))
...
#define _MAX_FEEDRATE {400, 400, 10, 45}       // (mm/sec)    
